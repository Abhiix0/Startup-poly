...
export const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Centered Hero Content Block (Header + Cards + HUD) */}
      <div className="flex-1 flex flex-col justify-center pt-6 sm:pt-10 md:pt-12 pb-2 sm:pb-4">
        {/* NES Sky Header */}
        <header className="relative pb-2 sm:pb-3 px-4 text-center z-10">
          {/* Level 1: Wordmark Logo */}
          <div className={`flex flex-col items-center select-none text-center mb-1 ${isFirstVisit ? 'anim-entrance-logo' : ''}`}>
