    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center pt-8 sm:pt-12 md:pt-16 pb-4 sm:pb-8 relative z-10">
        ...
        <header className="relative pb-4 sm:pb-6 px-4 text-center z-10">
          ...
          {/* Level 3: Hero Headline inside a solid retro dark plaque for high contrast */}
          <div className={`mt-2 sm:mt-3 text-center max-w-lg mx-auto px-2 ${isFirstVisit ? 'anim-entrance-tagline' : ''}`}>
            <div className="inline-block bg-[#102040] border-2 border-[#334155] shadow-[2px_2px_0px_#0A1220] px-3.5 py-1 sm:py-1.5 rounded-sm">
              <p
                className="font-pixel text-[10px] sm:text-xs text-[#FFFBEB] uppercase tracking-wider leading-snug"
                style={{
            ...
            <div className="flex flex-col items-center w-full max-w-[280px] opacity-90 hover:opacity-100 transition-opacity">
              ...
              >
                ...
                <div className="relative w-full bg-[#E2E8F0] border-2 border-[#64748B] shadow-inner pt-2 pb-2 px-2 sm:px-3 flex flex-col items-center justify-between gap-2 rounded-none z-10">
                  {/* 4 Corner Rivets */}
                  <div className="absolute top-1 left-1 w-1.5 h-1.5 rounded-full bg-[#94A3B8] border border-[#181E28]" />
                  <div className="absolute top-1 right-1 w-1.5 h-1.5 rounded-full bg-[#94A3B8] border border-[#181E28]" />
                  <div className="absolute bottom-1 left-1 w-1.5 h-1.5 rounded-full bg-[#94A3B8] border border-[#181E28]" />
                  <div className="absolute bottom-1 right-1 w-1.5 h-1.5 rounded-full bg-[#94A3B8] border border-[#181E28]" />
